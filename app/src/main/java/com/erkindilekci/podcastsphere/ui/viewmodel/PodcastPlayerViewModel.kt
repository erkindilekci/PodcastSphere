...
import com.erkindilekci.podcastsphere.data.service.MediaPlayerService
...
import com.erkindilekci.podcastsphere.util.currentPosition
import com.erkindilekci.podcastsphere.util.isPlayEnabled
import com.erkindilekci.podcastsphere.util.isPlaying
...
class PodcastPlayerViewModel @Inject constructor(
    ...
    suspend fun updateCurrentPlaybackPosition() {
        ...
        delay(Constants.PLAYBACK_POSITION_UPDATE_INTERVAL)
